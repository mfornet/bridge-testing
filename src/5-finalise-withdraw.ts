...
async function main() {
    ...
    const initialAmount = (
        await erc20.balanceOf(ethereumConfig.Address)
    ).toString();
    console.log(
        "Token balance of",
    ...
    try {
        ...
        console.log(
            "Because of some reason transaction was not applied as expected. Perhaps the execution outcome was already used."
        );
        return;
    }
