...
async function main() {
    ...
    console.log(
        ...
        "tokens in fungible token connector"
    );
    console.log(
        "--------------------------------------------------------------------------------"
    );
    ...
    const lockTx = await connector.lockToken(
    ...
    console.log(
        "Now you need to wait sufficient amount of time for the bridge to sync Ethereum chain on NEAR"
    );
    console.log(
        "Use hash of the locking transaction as an input to the next step"
    );
}
