...
async function main() {
    ...
    console.log(
        "Finalising deposit, that was started in Ethereum transaction",
        txHash
    );
    console.log(
        "--------------------------------------------------------------------------------"
    ...
    try {
        bridgedTokenAddress = (
            await connector.get_bridge_token_account_id({
        ...
        bridgedTokenAddress = await DeployToken.deployToken(
    ...
    console.log(
        "Bridged token balance of",
        nearConfig.Account,
        "before finalisation of the deposit:",
        initialBalance
    );
    ...
    console.log(
        "Bridged token balance of",
        nearConfig.Account,
        "after finalisation of the deposit: ",
        finalBalance
    );
}
